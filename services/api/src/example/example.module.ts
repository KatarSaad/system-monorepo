...
@Module({
  ...
  controllers: [ExampleController, SystemDemoController, FileUploadController],
  providers: [ExampleService, SystemDemoService, FileUploadService],
  exports: [ExampleService, SystemDemoService, FileUploadService],
})
